...
from src.data.loader import load_all_symbols, load_macro, load_market, load_fear_greed, load_onchain
...
def run(cfg, force: bool = False, symbol_filter: str = None) -> None:
    ...
    for tf in cfg.data.timeframes:
        ...
        onchain_df = load_onchain("BTCUSDT", raw_dir)
        onchain_panel = merge_onchain_to_index(master_index, fear_greed_df, onchain_df, cfg)
